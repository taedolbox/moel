...
# 현재 날짜와 시간 (2025년 5월 27일 오후 4:56 KST)
current_datetime = datetime(2025, 5, 27, 16, 56)
            ...
            for week in cal:
                ...
                for i, day in enumerate(week):
                    ...
                    week_html += (
                        ...
                        f'<div class="{class_name}" onclick="document.getElementById(\'{container_key}\').click();">{day}</div>'
                        f'</div>'
                    )
